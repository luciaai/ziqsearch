      ...
      <main className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-neutral dark:prose-invert max-w-none prose-headings:font-be-vietnam-pro prose-headings:font-light prose-headings:tracking-tight prose-h2:text-xl prose-h2:mt-12 prose-h2:mb-4 prose-p:text-muted-foreground prose-p:leading-relaxed prose-li:text-muted-foreground prose-a:text-foreground prose-a:font-medium prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground prose-strong:font-medium">
          <p className="text-base text-foreground/80 leading-relaxed">
            Welcome to Ziq. These Terms of Service govern your use of our website and services. By using Ziq,
          ...
          <p>
            By accessing or using Ziq, you acknowledge that you have read, understood, and agree to be bound by
            these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall
            be effective immediately upon posting. Your continued use of Ziq after any modifications indicates your
          ...
          <p>You agree not to use Ziq to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, Ziq:</p>
          <ul>
          ...
          <p>
            ...
            Ziq should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of Ziq, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of Ziq or its licensors and are protected by
          ...
          <p>
            Ziq offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of Ziq is also governed by our{' '}
            <Link href="/privacy-policy">Privacy Policy</Link>, which is incorporated into these Terms of Service by reference.
          </p>

          <h2>10. Limitation of Liability</h2>
          <p>
            To the maximum extent permitted by law, Ziq shall not be liable for any indirect, incidental, special,
          ...
          <p>
            Ziq is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to Ziq, with or without notice, for conduct
          ...
          <p>
            ...
            Ziq operates, without regard to its conflict of law provisions.
          </p>
        ...
        <div className="mt-16 pt-8 border-t border-border">
          <p className="text-sm text-muted-foreground">
            By using Ziq, you agree to these Terms of Service and our{' '}
