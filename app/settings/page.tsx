...
function SettingsContent() {
  ...
  const handleSignOut = useCallback(async () => {
    ...
    try {
      ...
      console.log('[SIGNOUT] Is mobile:', isMobile);
      
      if (isMobile) {
        // Use mobile-specific endpoint for iOS/Android
        console.log('[SIGNOUT] Using mobile signout endpoint');
        ...
        if (response.ok) {
          console.log('[SIGNOUT] Mobile signout success');
          localStorage.clear();
        ...
        console.log('[SIGNOUT] Using desktop signout');
        await signOut({
          fetchOptions: {
            onSuccess: () => {
  ...
  return (
    <div className="w-full">
      ...
      <main className="flex-1 overflow-auto p-4 md:p-6 max-w-7xl mx-auto w-full">
        {/* User Profile - Mobile */}
        <div className="lg:hidden mb-6 relative z-[60]">
          <Card className="p-4 shadow-none relative z-[60]">
            <div className="flex items-center gap-3">
