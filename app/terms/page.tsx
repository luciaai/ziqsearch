    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="py-16 px-4">
        <div className="container max-w-3xl mx-auto prose dark:prose-invert prose-neutral prose-headings:font-be-vietnam-pro prose-p:text-neutral-600 dark:prose-p:text-neutral-400 prose-a:text-neutral-900 dark:prose-a:text-neutral-200 prose-a:no-underline hover:prose-a:text-black dark:hover:prose-a:text-white prose-headings:tracking-tight">
          <p className="text-lg">
            Welcome to Ziq AI. These Terms of Service govern your use of our website and services. By using Ziq AI,
          ...
          <p>
            By accessing or using Ziq AI, you acknowledge that you have read, understood, and agree to be bound by
            these Terms of Service. We reserve the right to modify these terms at any time, and such modifications shall
            be effective immediately upon posting. Your continued use of Ziq AI after any modifications indicates your
            acceptance of the modified terms.
          </p>

          <h2>2. Description of Service</h2>
          <p>
            Ziq AI is a minimalistic AI-powered search engine that helps users find information on the internet. Our
          ...
          <p>You agree not to use Ziq AI to:</p>
          <ul>
          ...
          <p>While we strive to provide accurate and reliable information, Ziq AI:</p>
          <ul>
          ...
          <p>
            ...
            Ziq AI should not be used as the sole source for making important decisions, especially in professional,
            medical, legal, or financial contexts.
          </p>

          <h2>5. Intellectual Property</h2>
          <p>
            All content, features, and functionality of Ziq AI, including but not limited to text, graphics, logos,
            icons, images, audio clips, and software, are the property of Ziq AI or its licensors and are protected by
          ...
          <p>Ziq AI relies on third-party services to provide its functionality:</p>
          <ul>
          ...
          <p>
            By using Ziq AI, you acknowledge and agree that your data may be processed by these third-party services
            as described in our Privacy Policy.
          </p>

          <h2>7. Pricing and Billing</h2>
          <p>
            Ziq AI offers both free and paid subscription plans. For detailed pricing information, visit our{' '}
          ...
          <h2>9. Privacy</h2>
          <p>
            Your use of Ziq AI is also governed by our{' '}
          ...
          <p>
            To the maximum extent permitted by law, Ziq AI shall not be liable for any indirect, incidental, special,
          ...
          <p>
            Ziq AI is provided &quot;as is&quot; and &quot;as available&quot; without any warranties of any kind,
          ...
          <p>
            We reserve the right to suspend or terminate your access to Ziq AI, with or without notice, for conduct
          ...
          <p>
            ...
            Ziq AI operates, without regard to its conflict of law provisions.
          </p>

          <h2>14. Contact Us</h2>
          <p>If you have any questions about these Terms of Service, please contact us at:</p>
          <p>
            <a href="mailto:ziqsearch@gmail.com" className="flex items-center gap-1">
              ziqsearch@gmail.com <ExternalLink className="h-4 w-4" />
            </a>
          </p>

          <div className="my-8 border-t border-neutral-200 dark:border-neutral-800 pt-8">
            <p className="text-sm text-neutral-500 dark:text-neutral-400">
              By using Ziq AI, you agree to these Terms of Service and our{' '}
              <Link href="/privacy-policy" className="underline">
                Privacy Policy
              </Link>
              .
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm text-neutral-500 dark:text-neutral-400">
                © {new Date().getFullYear()} Ziq AI by Zaid Mukaddam
              </div>
            </div>
