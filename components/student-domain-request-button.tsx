...
`
    : ''
}I am a current student at this university and would love to access the student discount for Ziq Pro.
...
Best regards`;
  ...
  const handleSubmit = () => {
    ...
    const mailtoLink = `mailto:ziqsearch@gmail.com?subject=${encodeURIComponent(subject)}&body=${formattedBody}`;
